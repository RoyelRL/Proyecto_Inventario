...
$query=$con->prepare("SELECT * FROM `libro`WHERE id = :id ");
$query->execute(['id' => $id]);
/*$activo = 1;

$query = $con->prepare("SELECT codigo, descripcion, inventariable, stock FROM libro WHERE id = :id AND activo=:activo");
                ...
                <div class="col">
                    <form class="row g-3" method="POST" action="guarda.php" autocomplete="off">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control" value="<?php echo $row['nombre_libro']; ?>" required autofocus>
                        </div>
                        <div class="col-md-4">
